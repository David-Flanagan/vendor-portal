...
export function RecentActivity({ activities, groupByDate = true, className }: RecentActivityProps) {
...
export function ActivitySummary({ data, className }: ActivitySummaryProps) {
