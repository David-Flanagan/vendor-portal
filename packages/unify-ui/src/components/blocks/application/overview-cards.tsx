...
export function OverviewMetricCard({
  ...
  if (href) {
    return (
      <a href={href} className="block transition-colors hover:bg-muted/50">
...
export function OverviewCards({ cards, columns = 4, className }: OverviewCardsProps) {
  const gridCols = {
    1: 'grid-cols-1',
...
export function OverviewComparisonCard({
  title,
  current,
  previous,
  change,
