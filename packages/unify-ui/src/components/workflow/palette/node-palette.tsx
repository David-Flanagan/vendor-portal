...
export function NodePalette({
  ...
  const handleDragStart = (e: React.DragEvent, template: NodeTemplate) => {
    console.log('NodePalette: Starting drag with template:', template);
    ...
    console.log('NodePalette: Drag data set:', dragData);
      ...
      <CardContent className="flex-1 p-0 overflow-hidden">
        <div className="h-full overflow-auto px-3">
          {Object.keys(groupedTemplates).length === 0 ? (
            ...
            <Accordion type="multiple" defaultValue={Object.keys(groupedTemplates)}>
...
function NodePaletteItem({ template, onDragStart, onDragEnd }: NodePaletteItemProps) {
