...
import { WorkflowNode, Port } from '../types';
import {
  MoreVertical,
  Settings,
  Copy,
      ...
      >
        <CardHeader className="p-3 pb-2">
          <div className="flex items-start justify-between gap-2">
            ...
            {status !== 'idle' && (
              <Badge variant={statusColors[status]} className="h-5 gap-1">
                {statusIcons[status]}
...
function NodeHandle({ port, nodeId, isInput, index, total }: NodeHandleProps) {
